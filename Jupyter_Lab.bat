@echo off
%windir%\System32\cmd.exe "/C" C:\Users\GCM\anaconda3\Scripts\conda.exe info --envs 
...
%windir%\System32\cmd.exe "/K" C:\Users\GCM\anaconda3\Scripts\activate_julab.bat %conda_env%
